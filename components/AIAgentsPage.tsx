...
import { Bot, BrainCircuit, Network, ShieldCheck, Zap, Terminal, GitMerge, FileJson, ArrowRight, Cpu, Search, FileText, BarChart, Users, Lock, Database, Layers, Activity, Radio, Server } from 'lucide-react';
import { SwissGrid, Section, SectionHeadline, MonoLabel, BodyText, SectionNumber, Card, ButtonPrimary, ButtonOutline, Input, AccentLine } from './UI';
...
export const AIAgentsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black-rich text-gray-100 pt-20">
      
      {/* --- HERO SECTION REDESIGNED --- */}
      <section className="relative min-h-[90vh] flex flex-col justify-center border-b border-gray-800 overflow-hidden">
        
        {/* Animated Shader Background */}
        <div className="absolute inset-0 z-0 bg-black-rich">
           <div className="absolute top-[-20%] left-[20%] w-[600px] h-[600px] bg-accent-primary/20 rounded-full blur-[120px] mix-blend-screen animate-blob"></div>
           <div className="absolute bottom-[0%] right-[-10%] w-[500px] h-[500px] bg-purple-900/20 rounded-full blur-[100px] mix-blend-screen animate-blob animation-delay-2000"></div>
           <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 mix-blend-overlay"></div>
           <div className="absolute inset-0 bg-grid-pattern opacity-[0.05]"></div>
        </div>

        <SwissGrid className="relative z-10 items-center h-full py-20">
          
          {/* Left: Typography */}
          <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
            <div className="animate-fade-in-up">
                <MonoLabel className="mb-6 text-accent-primary" color="text-accent-primary">Neural Orchestration Layer</MonoLabel>
                <h1 className="text-7xl md:text-8xl lg:text-[9rem] font-bold text-white leading-[0.85] tracking-tighter uppercase font-sans mb-8">
                  AI Agents
                </h1>
                <p className="text-xl md:text-2xl text-gray-300 font-light max-w-xl leading-relaxed border-l-2 border-white/20 pl-8 mb-12">
          ...
          {/* Right: UI Component (Swarm Monitor) */}
          <div className="col-span-12 lg:col-span-5 flex justify-end mt-12 lg:mt-0">
             <div className="w-full max-w-[500px] animate-fade-in-right delay-200">
                <div className="relative glass-card bg-black/40 border border-white/10 p-1">
                   {/* Top Bar */}
                   <div className="flex items-center justify-between bg-black/60 px-4 py-3 border-b border-white/5">
                      <div className="flex items-center gap-3">
                         <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                         <span className="font-mono text-xs text-gray-400 uppercase tracking-wider">Swarm_Monitor_v1.0</span>
                      </div>
                   ...
                   {/* Main Monitor Area */}
                   <div className="p-6 relative overflow-hidden min-h-[300px] flex flex-col justify-between">
                      {/* Grid bg */}
                      ...
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                         <div className="relative w-32 h-32 flex items-center justify-center">
                            <div className="absolute inset-0 border border-accent-primary/30 rounded-full animate-ping opacity-20"></div>
                            <div className="absolute inset-0 border border-accent-primary/20 rounded-full w-[120%] h-[120%] -top-[10%] -left-[10%] animate-spin-slow border-dashed"></div>
                            <div className="w-16 h-16 bg-accent-primary/10 rounded-full border border-accent-primary backdrop-blur flex items-center justify-center z-10 shadow-[0_0_30px_rgba(0,71,255,0.3)]">
                               <Cpu className="text-accent-primary w-8 h-8" />
                            </div>
                            
                            {/* Satellites */}
                            <div className="absolute top-0 right-0 w-3 h-3 bg-white rounded-full animate-float"></div>
                            <div className="absolute bottom-0 left-4 w-2 h-2 bg-gray-500 rounded-full animate-pulse"></div>
                            <div className="absolute top-10 -left-10 w-8 h-8 border border-gray-700 bg-black/50 backdrop-blur rounded flex items-center justify-center">
                      ...
                      <div className="relative z-10 flex justify-between items-end">
                         <div className="space-y-4">
                            ...
                            <div>
                               ...
                               <div className="text-xl font-bold text-accent-primary font-mono">2,492</div>
                            </div>
                         </div>
                         ...
                         <div className="flex items-end gap-1 h-12">
                            {[30, 50, 40, 70, 50, 80, 60, 90, 75, 50].map((h, i) => (
                               <div key={i} className="w-2 bg-gray-800 hover:bg-accent-primary transition-colors duration-300" style={{ height: `${h}%` }}></div>
                            ))}
                         </div>
                      </div>
                   </div>
      ...
      <Section id="catalog">
        ...
        <SwissGrid className="mb-16">
          <div className="col-span-12 lg:col-span-8">
             <MonoLabel className="mb-4">Agent Catalog</MonoLabel>
              ...
              <Card className="h-full flex flex-col justify-between group">
                 <div>
                    <div className="flex justify-between items-start mb-6">
                       <div className="p-3 bg-gray-900 border border-gray-800 text-accent-primary">
                          <Search size={24} />
                       </div>
                    ...
                    <h3 className="text-2xl font-bold text-white uppercase mb-2 group-hover:text-accent-primary transition-colors">Vesta</h3>
           ...
           <div className="col-span-12 md:col-span-4">
              <Card className="h-full flex flex-col justify-between group">
                 <div>
                    ...
                    <h3 className="text-2xl font-bold text-white uppercase mb-2 group-hover:text-accent-primary transition-colors">Mercury</h3>
           ...
           <div className="col-span-12 md:col-span-4">
              <Card className="h-full flex flex-col justify-between group">
                 <div>
                    ...
                    <h3 className="text-2xl font-bold text-white uppercase mb-2 group-hover:text-accent-primary transition-colors">Janus</h3>
           ...
           <div className="col-span-12 md:col-span-4">
              <Card className="h-full flex flex-col justify-between group">
                 <div>
                    ...
                    <h3 className="text-2xl font-bold text-white uppercase mb-2 group-hover:text-accent-primary transition-colors">Atlas</h3>
           ...
           <div className="col-span-12 md:col-span-4">
              <Card className="h-full flex flex-col justify-between group">
                 <div>
                    ...
                    <h3 className="text-2xl font-bold text-white uppercase mb-2 group-hover:text-accent-primary transition-colors">Orion</h3>
           ...
           <div className="col-span-12 md:col-span-4">
              <Card className="h-full flex flex-col justify-between group">
                 <div>
                    ...
                    <h3 className="text-2xl font-bold text-white uppercase mb-2 group-hover:text-accent-primary transition-colors">Vulcan</h3>
      ...
      <Section className="bg-gray-900/20">
         ...
         <SwissGrid>
            <div className="col-span-12 lg:col-span-5 mb-12 lg:mb-0">
               <MonoLabel className="mb-4">Under the Hood</MonoLabel>
               ...
               <ul className="space-y-6">
                  {[
                     ...
                     <li key={i} className="flex gap-4">
                        <div className="mt-1 w-2 h-2 bg-accent-primary shrink-0"></div>
                        <div>
                           <h4 className="text-white font-bold uppercase text-sm mb-1">{feature.title}</h4>
            ...
            <div className="col-span-12 lg:col-span-7 lg:pl-12">
               {/* Terminal UI */}
               <div className="w-full bg-black-card border border-gray-800 font-mono text-xs md:text-sm rounded-none overflow-hidden shadow-2xl">
                  {/* Terminal Header */}
                  ...
                  {/* Terminal Body */}
                  <div className="p-6 bg-black text-gray-300 space-y-1 h-[400px] overflow-hidden relative">
                     ...
                     {displayedLines.map((line, i) => (
                       <div key={i} className={`${line.type === 'success' ? 'text-green-500' : line.type === 'warning' ? 'text-yellow-500' : line.type === 'cmd' ? 'text-white' : 'text-gray-400'} font-mono leading-relaxed`}>
                         {line.text}
                         {line.type === 'cursor' && <span className="animate-pulse">_</span>}
                       </div>
                     ))}

                     {/* Graphic Overlay inside terminal */}
                     <div className="absolute bottom-6 right-6 p-4 border border-gray-800 bg-black/80 backdrop-blur pointer-events-none sticky">
                        ...
                        <div className="flex items-end gap-1 h-12 w-32">
                           {[40, 65, 30, 80, 50, 90, 45, 70, 60, 50, 85, 40].map((h, i) => (
                              <div key={i} className="flex-1 bg-accent-primary/50 hover:bg-accent-primary transition-colors" style={{ height: `${h}%` }}></div>
                           ))}
                        </div>
                     </div>
                  </div>
      ...
      <Section id="specs">
         ...
         <SwissGrid>
            <div className="col-span-12 mb-12">
                <MonoLabel className="mb-4">Deep Dive</MonoLabel>
                <SectionHeadline>Technical Specifications</SectionHeadline>
            </div>
            
            {/* Column 1: Model Arch */}
            <div className="col-span-12 md:col-span-4">
                <div className="border-t border-accent-primary pt-6">
                    <Layers className="w-8 h-8 text-white mb-6" />
                    <h3 className="text-2xl font-bold text-white uppercase mb-4">Model Architecture</h3>
            ...
            <div className="col-span-12 md:col-span-4">
                <div className="border-t border-gray-700 pt-6">
                    ...
                    <h3 className="text-2xl font-bold text-white uppercase mb-4">Data Processing</h3>
                    <p className="text-gray-400 leading-relaxed">
            ...
            <div className="col-span-12 md:col-span-4">
                <div className="border-t border-gray-700 pt-6">
                    ...
                    <h3 className="text-2xl font-bold text-white uppercase mb-4">Security Protocols</h3>
                    <p className="text-gray-400 leading-relaxed">
      ...
      <Section id="deploy">
         ...
         <SwissGrid className="items-center">
             <div className="col-span-12 lg:col-span-6">
                 <MonoLabel className="mb-4 text-accent-primary" color="text-accent-primary">Onboarding</MonoLabel>
                 ...
                 <div className="space-y-6 mb-10">
                     <div className="flex gap-4 items-start">
                         <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-sm font-mono text-white shrink-0">01</div>
                         <div>
                             <h4 className="text-white font-bold uppercase mb-1">Select Template</h4>
                             <p className="text-sm text-gray-400">Choose from our library of pre-trained agents.</p>
                         </div>
                     </div>
                     <div className="flex gap-4 items-start">
                         <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-sm font-mono text-white shrink-0">02</div>
                         <div>
                             <h4 className="text-white font-bold uppercase mb-1">Connect Data Sources</h4>
                             <p className="text-sm text-gray-400">Securely link your ERP, CRM, and logistics feeds.</p>
                         </div>
                     </div>
                     <div className="flex gap-4 items-start">
                         <div className="w-8 h-8 rounded-full bg-accent-primary flex items-center justify-center text-sm font-mono text-white shrink-0">03</div>
                         <div>
                             <h4 className="text-white font-bold uppercase mb-1">Activate</h4>
                             <p className="text-sm text-gray-400">Go live with monitored autonomous execution.</p>
                         </div>
                     </div>
                 </div>
             ...
             <div className="col-span-12 lg:col-span-6 mt-12 lg:mt-0">
                 ...
                 <div className="bg-black-card border border-gray-800 p-2 relative">
                     <div className="absolute top-0 left-0 w-full h-1 bg-accent-primary animate-pulse"></div>
                     <div className="bg-gray-900/50 p-8 border border-gray-800/50 flex flex-col gap-4">
                         <div className="h-2 w-1/3 bg-gray-700 rounded"></div>
                         <div className="h-2 w-2/3 bg-gray-800 rounded"></div>
                         <div className="h-32 bg-black/40 border border-gray-800 mt-4 flex items-center justify-center">
                             <div className="text-xs font-mono text-accent-primary animate-pulse">INITIALIZING DEPLOYMENT SEQUENCE...</div>
                         </div>
                         <div className="grid grid-cols-3 gap-2 mt-2">
                             <div className="h-20 bg-gray-800/30 border border-gray-700/30"></div>
                             <div className="h-20 bg-gray-800/30 border border-gray-700/30"></div>
                             <div className="h-20 bg-gray-800/30 border border-gray-700/30"></div>
                         </div>
                     </div>
      ...
      <Section className="border-b-0">
         <SwissGrid>
            <div className="col-span-12 text-center">
               <div className="inline-block p-4 border border-accent-primary/30 bg-accent-primary/5 mb-8 rounded-full">
                  <Cpu className="w-8 h-8 text-accent-primary" />
               </div>
               <h2 className="text-4xl md:text-5xl font-bold text-white uppercase mb-6">Ready to Automate?</h2>
